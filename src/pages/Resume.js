      ...
      <div className="text-[#a2aabc] text-lg mt-5">
        <div className="flex flex-row">
          ...
          <div className="w-3/4">
            ...
            <br />
            <code className="text-xs text-brown_vs">• 2014 - 2018</code>
          </div>
        </div>
        <div className="flex flex-row pt-10">
          ...
          <div className="w-3/4">
            ...
            <code className="italic text-sm text-lightblue_vs">
              <a
                href="https://www.sabuyleasing.co.th/"
            ...
            <br />
            <code className="text-xs text-brown_vs">• Oct 2021 - Jun 2025</code>
            <br />
            <code className="text-base">
              <br />• Design and Develop API service connect to Webapp with LINE
              and LIFF (Backend using NodeJS, Frontend using React).
              <br />• Manage, edit and design the company's website with
              Wordpress.
              <br />• Providing troubleshooting services for equipment in our
              compamy more than 120 branches.
            </code>
            ...
            <div className="container mx-auto space-y-2 lg:space-y-0 lg:gap-2 lg:grid lg:grid-cols-2">
              <img
                src={HomepageSBImg}
                className="h-full w-96 rounded-lg md:h-full md:w-72 p-1 hover:scale-125 transition-all duration-500 cursor-pointer"
                alt="homepage-Sabuy-leasing-website"
              />

              <img
                src={LineXSB}
                className="h-full w-96 rounded-lg md:h-full md:w-72 p-1 hover:scale-125 transition-all duration-500 cursor-pointer"
                alt="project-line-payment"
              />
            </div>
            {/* </div> */}
          </div>
        ...
        <div className="flex flex-row pt-10">
          ...
          <div className="w-3/4">
            ...
            <code className="text-base">
              ...
              <br />• Set up audio equipment for installation according Sound
              System Design.
            </code>
            <br />
            <br />
            <div className="container mx-auto space-y-2 lg:space-y-0 lg:gap-2 lg:grid lg:grid-cols-2">
              <img
                src={HomepageAtImg}
                className="h-full w-96 rounded-lg md:h-full md:w-72 p-1 hover:scale-125 transition-all duration-500 cursor-pointer"
                alt="homepage-at-pro-sound-website"
              />
        ...
        <div className="flex flex-row pt-10">
          ...
          <div className="w-3/4">
            ...
            <code className="text-base">
              ...
              <br />• Configuration device for connect vehicle with CANBUS
              communication.
              <br />• Translate articles, manuals, etc. to make it easier for
              users.
              <br />• Contact with foreign from both China and Europe who are
              partners for develop product together.
            </code>
            <br />
            <br />
            ...
            <div className="container mx-auto space-y-2 lg:space-y-0 lg:gap-2 lg:grid lg:grid-cols-2">
              <img
                src={HomepageWaylarImg}
                className="h-full w-96 rounded-lg md:h-full md:w-72 p-1 hover:scale-125 transition-all duration-500 cursor-pointer"
                alt="homepage-waylar-tech-website"
              />

              <img
                src={WithPartnerWaylar}
                className="h-full w-96 rounded-lg md:h-full md:w-72 p-1 hover:scale-125 transition-all duration-500 cursor-pointer"
                alt="partner-of-waylar"
              />

              <img
                src={WithPartnerWaylar2}
                className="h-full w-96 rounded-lg md:h-full md:w-72 p-1 hover:scale-125 transition-all duration-500 cursor-pointer"
                alt="installation-with-partner"
              />

              <img
                src={Embedded}
                className="h-full w-96 rounded-lg md:h-full md:w-72 p-1 hover:scale-125 transition-all duration-500 cursor-pointer"
                alt="design-and-solder"
              />
            </div>
          </div>
        </div>
